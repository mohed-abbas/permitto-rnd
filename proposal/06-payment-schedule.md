...
## 6.2 Development Payment Milestones

| # | Milestone | Trigger | Amount (USD) |
|---|-----------|---------|-------------|
| 1 | **Project Kick-Off** | Contract signing — before development begins | $4,000 |
| 2 | **Working Prototype Delivered** | Sprint 1 complete — live staging URL with core PTW workflow (4-level approval, zones, PTW Register) | $1,600 |
| 3 | **SIMOPs & Advanced Workflows** | Sprint 2 complete — SIMOPs with countersign, condition change, permit extension | $1,400 |
...
## 6.3 Support & Maintenance Payment
...
| Invoice | Issued upon milestone completion with deliverable summary |
| Payment Due | Within 7 business days of invoice date |
| Milestone Sign-Off | Client confirms deliverable acceptance via sprint review before payment is due |
| Late Payment | Work may be paused if payment is overdue by more than 14 days |

---

## 6.6 Payment Timeline Overview

| Week | Event | Payment |
|------|-------|---------|
| Week 0 | Contract signing | $4,000 (kick-off) |
| Week 3 | Sprint 1 — Prototype delivered | $1,600 |
| Week 5 | Sprint 2 — SIMOPs & workflows | $1,400 |
| Week 7 | Sprint 3 — PDFs & notifications | $1,200 |
